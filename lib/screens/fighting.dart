...
class Fighting extends StatefulWidget {
  const Fighting({super.key});

  @override
  State<Fighting> createState() => FightingState();
}

String stringResponse = ' ';
List listResponse = [];

class FightingState extends State<Fighting> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: Text('Fighting Games'), centerTitle: true,backgroundColor: Colors.black,),
